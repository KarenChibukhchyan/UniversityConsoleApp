        ...
        public override void Print(Person person)
        {
            ...
            if (person is Student)
            {
                if (((Student)person).Teacher == null)
                    ...
                    Console.WriteLine($"Teacher of this student: id:{((Student)person).Teacher.ID} name:{((Student)person).Teacher.FirstName} lastName:{((Student)person).Teacher.LastName} age:{((Student)person).Teacher.Age}");
            }
            Console.WriteLine();
        }
